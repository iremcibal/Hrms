...
public class UCNKPSPublicSoap12
{
    ...
    public UCNKPSPublicSoap12(){}

    public UCNKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public UCNKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UCNExtendedSoapSerializationEnvelope envelope= new UCNExtendedSoapSerializationEnvelope(UCNExtendedSoapSerializationEnvelope.VER12);
