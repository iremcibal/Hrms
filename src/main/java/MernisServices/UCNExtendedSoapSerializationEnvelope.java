...
public class UCNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UCNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UCNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UCNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UCNDateTimeConverter dateTimeConverter = new UCNStandardDateTimeConverter();

    public UCNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UCNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UCNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UCNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UCNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UCNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
