...
public class RTMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RTMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RTMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RTMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RTMDateTimeConverter dateTimeConverter = new RTMStandardDateTimeConverter();

    public RTMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RTMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RTMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RTMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RTMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RTMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
