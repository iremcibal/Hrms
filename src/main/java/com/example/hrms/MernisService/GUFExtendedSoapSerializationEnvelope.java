...
public class GUFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GUFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GUFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GUFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GUFDateTimeConverter dateTimeConverter = new GUFStandardDateTimeConverter();

    public GUFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GUFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GUFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GUFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GUFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GUFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
